  ...
  return [
    {
      ...
      bodyText: "RRF k equals sixty fuses ranked lists. Robust across tasks.",
    ...
    },
    {
      ...
      bodyText: "Markdown is ground truth. Hybrid retrieval beats single backend.",
    ...
    },
    {
      ...
      bodyText: "Sensitive content is stripped at staging. Audit log stays.",
