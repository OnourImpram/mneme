---
name: mneme-prime
description: Use when the user starts a new task that may have prior vault context worth surfacing. Invokes the mneme_prime MCP tool to build a token-budgeted preamble of recent sessions and topic matches.
---
...
- The user invokes this skill directly with `/skills` or `$mneme-prime`.
